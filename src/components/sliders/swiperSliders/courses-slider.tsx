...
import { VectorLeft, VectorRight } from "../../../components/svg-format-components"
...
const CoursesSlider: FC<BlogSliderProps> = ({ handlePrevClick, handleNextClick }) => {
  ...
  return (
    <div className="certificate-sliders-wrapper">
      {courseSlides.map((el, index) => (
        ...
        >
          {index % 2 === 0 ? (
            <div>
              <SwiperSlide className="info-slide">
              ...
              <SwiperSlide className="form-slide">
                <div className="form-wrapper overall-form-wrapper">
